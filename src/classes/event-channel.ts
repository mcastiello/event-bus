...
export class EventChannel<Definitions extends GenericEventBusDefinition, Channel extends ChannelOf<Definitions>> {
  ...
  private eventCache: ChannelCache<Definitions, Channel> = {};
  private eventSubscriptions: ChannelSubscriptions<Definitions, Channel> = {};
  private eventInterceptors: ChannelInterceptors<Definitions, Channel> = {};
  private eventResponders: ChannelResponders<Definitions, Channel> = {};
  ...
  private parseEventPayload<Event extends EventOf<Definitions, Channel>>(
    event: Event,
  ...
  private notifyData<Event extends EventOf<Definitions, Channel>>(
    event: Event,
    payload: EventDataOf<Definitions, Channel, Event>,
